...
const CartItem = (props) => {
  ...
  return (
    <Space className="cartItem">
      <Image src={props.product?.images[0]} width={96}></Image>
      <Space className="cartItem__infor" direction="vertical">
        <div className="cartItem__name">{props?.product?.title}</div>
      ...
      <div className="cartItem__price">{props.product?.price}$</div>
