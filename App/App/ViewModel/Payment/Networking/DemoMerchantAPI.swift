...
final class DemoMerchantAPI {
    ...
    public func getClientID(environment: EnvironmentPaypal, selectedMerchantIntegration: MerchantIntegration) async -> String? {
    ...
    private func buildURLRequest<T>(method: String, url: URL, body: T, header: [String: String]? = nil) -> URLRequest where T: Encodable {
    ...
    private func buildBaseURL(with endpoint: String, selectedMerchantIntegration: MerchantIntegration = .direct) -> URL? {
        return URL(string: EnvironmentPaypal.sandbox.baseURL + selectedMerchantIntegration.path + endpoint)
    }
    ...
    private func fetchClientID(environment: EnvironmentPaypal, selectedMerchantIntegration: MerchantIntegration) async -> String? {
        do {
